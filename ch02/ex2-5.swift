 ...
 * 이렇게도 됩니다.
 ...
 텍스트를 굵게 표기하고 싶으면 __Two pair of marks__ 를 사용하면 됩니다.
 ...
 ===
  ...
  바를 사용하면 바로 위 텍스트를 중간 크기 제목으로 표시해줍니다. 텍스트 앞에 #을 두개 붙여줘도
 동일한 효과를 냅니다.
 
  사용 예
  ----

  다른 텍스트보다 네 칸 이상 들여쓰기를 하면 코드 블록을 만들어 줍니다. 또한 강세표(backquote, `)
 를 네 개 이상 한 쌍으로 묶어도 코드 블록을 만들어줍니다.
